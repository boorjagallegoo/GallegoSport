...
public class Usuarios extends javax.swing.JPanel {
    ...
    /**
     * Maneja el evento de clic en el botón de búsqueda de usuarios.
     *
     * @param evt Evento de acción que desencadenó este método.
     */
    private void btn_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchActionPerformed
        try {
            // Se obtiene una instancia del DAO de Usuario utilizando la implementación MySQL
            UsuarioDAO dao = new MySQLUsuarioDAO();
            ...
            // Se realiza la búsqueda de usuarios y se agregan al modelo de la tabla
            dao.listar(buscarUsuarios.getText()).forEach((u)
                    -> model.addRow(new Object[]{u.getIdUsuario(), u.getNombre(), u.getApellidos(), u.getRol(), u.getClave()})
            );
        } catch (Exception e) {
